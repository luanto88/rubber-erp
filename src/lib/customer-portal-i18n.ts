...
const STRINGS = {
  vi: {
    ...
    errorExportBlocked: "Chưa thể xuất file định vị GeoJSON do dữ liệu vùng trồng chưa đầy đủ. Vui lòng liên hệ nhà cung cấp để được hỗ trợ.",
    ...
    factoriesLoadFailedHint: "Không tải được danh sách nhà máy, có thể do mạng chậm.",
    retryLoadFactories: "Thử lại",
    ...
    loginHeading: "ĐĂNG NHẬP HỆ THỐNG",
    loginSubheading: "Vui lòng đăng nhập để tiếp tục",
    ...
    featureDispatchBullet: "Điều xe - Kho nguyên liệu - Thành phẩm theo dõi xuyên suốt dây chuyền",
    featureQualityBullet: "Kiểm nghiệm chất lượng theo TCCS/TCVN, gắn liền xuất hàng",
    featureEudrBullet: "Truy xuất chuỗi cung ứng EUDR đến từng lô vườn cao su",
    isoQualityLabel: "Quản lý chất lượng",
    isoEnvironmentLabel: "Quản lý môi trường",
    isoCarbonLabel: "Carbon footprint",
    commitQualityTitle: "Chất lượng",
    commitQualitySubtitle: "Bền vững",
    commitEnvironmentTitle: "Môi trường",
    commitEnvironmentSubtitle: "Xanh sạch",
    commitResponsibilityTitle: "Trách nhiệm",
    commitResponsibilitySubtitle: "Minh bạch",
  ...
  en: {
    ...
    errorExportBlocked: "Unable to export the GeoJSON file because the plantation geometry data is incomplete. Please contact your supplier for support.",
    ...
    factoriesLoadFailedHint: "Could not load the factory list, possibly due to a slow connection.",
    retryLoadFactories: "Retry",
    ...
    loginHeading: "SYSTEM LOGIN",
    loginSubheading: "Please sign in to continue",
    rememberMeLabel: "Remember me",
    forgotPasswordLabel: "Forgot password?",
    showPasswordAria: "Show password",
    hidePasswordAria: "Hide password",
    featureDispatchBullet: "Dispatch - Raw materials - Finished goods tracked across the entire production line",
    featureQualityBullet: "Quality testing per TCCS/TCVN standards, integrated with exports",
    featureEudrBullet: "EUDR supply-chain traceability down to each rubber plantation plot",
    isoQualityLabel: "Quality management",
    isoEnvironmentLabel: "Environmental management",
    isoCarbonLabel: "Carbon footprint",
    commitQualityTitle: "Quality",
    commitQualitySubtitle: "Sustainable",
    commitEnvironmentTitle: "Environment",
    commitEnvironmentSubtitle: "Clean & green",
    commitResponsibilityTitle: "Responsibility",
    commitResponsibilitySubtitle: "Transparent",
