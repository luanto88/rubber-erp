                  ...
                  <div className="mb-4 flex flex-wrap items-start justify-between gap-3">
                    ...
                    <div className="flex flex-col items-end gap-2">
                      {detail.candidateWarehouseIds.length >= 2 ? (
                        <div className={`rounded-xl border px-3 py-2 ${detail.missingWarehouse ? "border-amber-300 bg-amber-50" : "border-violet-200 bg-violet-50"}`}>
                          ...
                          <select
                            ...
                            className="rounded-lg border border-violet-300 bg-white px-2 py-1 text-xs font-semibold text-slate-700 outline-none"
                          >
                            <option value="">-- Chọn kho --</option>
