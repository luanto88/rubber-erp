...
import { AlertTriangle, Check, CopyPlus, Printer, Save, Trash2 } from "lucide-react"
import { getFreshAuthSession, hydrateActiveSession } from "@/lib/auth"
...
export default function InventoryReceiptsPage() {
  ...
  const documentQrPath = draft.documentId ? `/dashboard/inventory/receipts?code=${encodeURIComponent(documentCode)}` : null
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div>
                          ...
                          <div className="mt-2 text-xs text-slate-500">
                            Tồn hiện tại: {item.opening_stock.toLocaleString("vi-VN")} {item.unit}
                          </div>
                        </div>
                        <div
