...
const DICT: Record<Lang, Record<string, string>> = {
  ...
  km: {
    ...
    plPageTitle: "ស្វែងរកកញ្ចប់ផលិតផលសម្រេច",
    plPageSubtitle: "បើកពី QR លើស្លាកកញ្ចប់ ដើម្បីមើលប្រភពដើមវត្ថុធាតុដើម។",
    plNotFoundMessage: "រកមិនឃើញព័ត៌មានកញ្ចប់មូល ឬតំណភ្ជាប់មានបញ្ហា។ សូមពិនិត្យ ហើយស្កេនកូដ QR ម្តងទៀត។",
    plRetry: "ព្យាយាមម្តងទៀត",
    plStatusPredicted: "ព្យាករណ៍ — មិនទាន់ផលិត",
    plStatusProduced: "បានផលិតរួច",
    plStatusPartial: "ដំណើរការ — មិនទាន់មានទិន្នន័យកញ្ចប់នេះ",
    ...
    plXemChiTietNgan: "មើលព័ត៌មានលម្អិតប្រអប់ប្រភព៖ {nganTen}",
